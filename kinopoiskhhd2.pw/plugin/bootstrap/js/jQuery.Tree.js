...
(function($){
	...
	var COLLAPSE_ALL_CODE = '<span class="btn btn-danger btn-small ' + CLASS_JQUERY_TREE_COLLAPSE_ALL + '">Свернуть все</span>';
	var EXPAND_ALL_CODE = '<span class="btn btn-success btn-small ' + CLASS_JQUERY_TREE_EXPAND_ALL + '">Развернуть все</span><br />';
