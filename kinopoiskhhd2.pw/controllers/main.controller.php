...
class Main extends DB{
	...
	public function getSerialMovies($id,$bgr){
		if($bgr !=""){
			return 'src="http://imagees2.pw/i2/'.$id.'/'.$bgr.'" style="background-image: url(http://imagees2.pw/i2/'.$id.'/'.$bgr.');background-size: cover;background-position: 50% 0;background-attachment: fixed;background-repeat: no-repeat"';	
		} else {
			return 'src="noimage"';
		}
    }
