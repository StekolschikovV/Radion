...
function positionEl() {
    if ($( document ).width() <= 950){
        var  e = 1.76;
        // $('.videoBlock').height($('.cont-video').width()/1.78);
        $('.videoBlock').height($('.cont-video').width()/e);
        $('.videoBlock').width($(document).width());
        // $('#player').height($('.cont-video').width()/1.78);
        $('#player').height($('.cont-video').width()/e);
        $('#player').width($(document).width());

        $('.controlPanel').css("top", ($('.videoBlock').height() - 40) + 'px');

    } else {
        $('.videoBlock').height($('.cont-video').height());
        $('.videoBlock').width($('.cont-video').width());
        $('#player').height($('.cont-video').height()+42);
        $('#player').width($('.cont-video').width());
